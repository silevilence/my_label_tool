...
export const PRELABEL_ZH_CN = {
  ...
  ptUnsupported: "PyTorch .pt 模型需要先转换",
  ptInstruction: "确认转换参数后，应用会生成 ONNX、校验模型并加入导入流程。",
  ptConvertNow: "一键转换为 ONNX",
  ptConverting: "正在转换并校验…",
  ptImgSizeInvalid: "imgsz 必须是大于 0 的 32 倍数",
  ptEnvironmentUnavailable: "当前没有可用的 .pt 转换环境",
  ...
  ptPreparingCommand: "正在生成隔离转换命令…",
  ptLiveOutput: "实时输出",
  ptWaitingForOutput: "等待命令行输出…",
  ptStartConversion: "开始转换",
  ptCancelConversion: "中止转换",
  ptCancelling: "正在终止转换进程树并清理临时文件…",
  ptConversionRunning: (timeoutSeconds: number | null) =>
  ...
  pluginSourceReady: "已启用，可作为模型来源",
  pluginSourceDescription: (types: string) => `插件输出类型：${types || "未声明"}`,
